...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b  border-b-gray-400">
      ...
      {/* Home, AllDoctors, about, contact route starts from here  */}
      <ul className="hidden md:flex items-start gap-5 font-medium">
       ...
       {/* Home, AllDoctors, about, contact route ends here  */}


         {/* User Profile - Profile, Appointment, logout functionalities  */}
      ...
      <div className="flex items-center gap-4">
        ...
        <div className={` ${showMenu ? 'fixed w-full' : 'h-0 w-0'}    md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
            ...
            <div className='flex items-center justify-between px-5 py-6'>
              <img className='w-36' src={assets.logo} alt="logo_icon" />
            ...
            <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
              ...
              <NavLink  onClick={() => setShowMenu(false)} to='/contact'><p className='px-2 py-2 rounded  inline-block'>CONTACT US</p></NavLink>
            </ul>
