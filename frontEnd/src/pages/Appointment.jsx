...
const Appointment = () => {
  ...
  return docInfo && (
    <div>
      ...
      <div>
        <img className='bg-primary w-full sm:max-w-72 rounded-lg' src={docInfo.image} alt="" srcset="" />
      </div>

        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          {/* name, degree, experience */}
          <p className='flex items-center gap-2 text-2xl font-medium text-gray-900'>{docInfo.name} <img src={assets.verified_icon} alt="verifiedicon"  /></p>
          ...
          <div>
            ...
            <p className='text-sm text-gray max-w-[700px] mt-1'>{docInfo.about}</p>
          </div>
